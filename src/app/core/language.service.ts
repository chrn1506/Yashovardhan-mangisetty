...
export class LanguageService {
  ...
  private readonly dictionary: LanguageDictionary = {
    en: {
      ...
      'booking.specialty': 'Interventional Pulmonologist, Allergy & Sleep Specialist',
      'booking.experienceHighlight':
        '9 years of clinical experience and 3000+ interventional pulmonary procedures completed',
      ...
      'about.title': 'About',
      'about.yearsExp': '9 years of experience',
    ...
    hi: {
      ...
      'booking.specialty': 'इंटरवेंशनल पल्मोनोलॉजिस्ट, एलर्जी और नींद विशेषज्ञ',
      'booking.experienceHighlight':
        '9 years of clinical experience and 3000+ interventional pulmonary procedures completed',
      ...
      'about.title': 'परिचय',
      'about.yearsExp': '9 वर्ष का अनुभव',
    ...
    te: {
      ...
      'booking.specialty': 'ఇంటర్వెన్షనల్ పల్మనాలజిస్ట్, అలెర్జీ మరియు నిద్ర నిపుణుడు',
      'booking.experienceHighlight':
        '9 years of clinical experience and 3000+ interventional pulmonary procedures completed',
      ...
      'about.title': 'గురించి',
      'about.yearsExp': '9 సంవత్సరాల అనుభవం',
